UESP32 Is a UDP Client that fires from the client,making responsive button detection to send into the host machine,making it to send keys,and some other things
